...
class YoloTrain(object):
    def __init__(self):  # 从config文件获取到一些变量
        ...
        print( l2_loss)
        l2_loss_1 = tf.losses.get_regularization_loss()
        print(l2_loss_1 )
        ...
        with tf.name_scope("define_first_stage_train"): # 第一阶段训练，只训练指定层
            ...
            first_stage_optimizer = tf.train.AdamOptimizer(self.learn_rate).minimize(self.loss + l2_loss_1,
                                                                                     var_list=self.first_stage_trainable_var_list,global_step=self.global_step)
        ...
        with tf.name_scope("define_second_stage_train"):    # 第二阶段训练，释放所有层
            ...
            second_stage_optimizer = tf.train.AdamOptimizer(self.learn_rate).minimize(self.loss + l2_loss,
        ...
        with tf.name_scope('summary'):
            ...
            tf.summary.scalar('train_batch_statistics/loss_l2_1', l2_loss_1)
    ...
    def train(self):
        ...
        for epoch in range(1, 1 + self.first_stage_epochs + self.second_stage_epochs):
            ...
            for train_data in pbar:
                _, summary, train_step_loss, global_step_val, lr = self.sess.run(
